  ...
  return (
    <div className="relative left-[3%] sm:left-[0px] xs:left-[0px] bottom-[50%] max-container font-inter flex justify-center items-center w-full xl:flex-row flex-col my-5 xl:left-[50px] xl:px-20">
      ...
      <div className="p-2 md:p-0 flex flex-col items-center mt-[135px]">
          ...
          <div className="flex flex-row items-center text-center xl:text-[25px] md:text-[20px] sm:text-[19px] xs:text-[15px] font-normal opacity-50 px-10 sm:px-0 xs:px-0">
            <span className="md:ml-4 xl:ml-4 ml-2 px-5 animate-fade-up animate-once animate-duration-1000 animate-delay-100 animate-ease-linear">I'm a driven developer who enjoys transforming complex code into user-friendly solutions, inspired by a passion for innovation and problem-solving.</span>
          </div>
        </div>
